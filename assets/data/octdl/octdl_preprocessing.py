# source: https://github.com/MikhailKulyabin/OCTDL/blob/main/preprocessing.py
# @FDS: I just added seed_everything() to ensure reproducibility
...
parser.add_argument('--dataset_folder', type=str, default='./OCTDL', help='path to dataset folder')
parser.add_argument('--labels_path', type=str, default='./OCTDL_labels.csv', help='path to labels.csv')
